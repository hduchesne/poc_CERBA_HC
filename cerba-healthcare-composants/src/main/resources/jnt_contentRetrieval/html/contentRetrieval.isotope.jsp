...
<c:set var="categories2Filter" value="${currentNode.properties['j:filter']}"/>
<c:set var="nodeType" value="${currentNode.properties['j:type'].string}"/>

<c:set var="max" value="${currentNode.properties['maxItems'].long}"/>
<c:set var="sortDirection" value="${currentNode.properties['j:sortDirection'].string}"/>
<c:set var="sortCriteria" value="${currentNode.properties['j:criteria'].string}"/>
